...
//  ALOGD("%s: enter",__func__);
  ...
  if (mIspStats[v4l2_buf.index]->subdev_stat.ls.val != CIFISP_LS_INVAL) {
    if (mIspStats[v4l2_buf.index]->subdev_stat.ls.val == CIFISP_LS_NIGHT) {
      switchSubDevIrCutMode(0);
    } else if (mIspStats[v4l2_buf.index]->subdev_stat.ls.val == CIFISP_LS_DAY) {
