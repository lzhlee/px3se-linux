...
static void ClearDpfProfileList(List* l) {
  if (!ListEmpty(l)) {
    ...
    while (pDpfProfile) {
	  ...
	  if (pDpfProfile->FiltLevelRegConf.p_chr_h_mode) {
        free(pDpfProfile->FiltLevelRegConf.p_chr_h_mode);
      }
	  if (pDpfProfile->FiltLevelRegConf.p_chr_v_mode) {
        free(pDpfProfile->FiltLevelRegConf.p_chr_v_mode);
      }
	  if (pDpfProfile->FiltLevelRegConf.p_fac_bl0) {
        free(pDpfProfile->FiltLevelRegConf.p_fac_bl0);
      }
	  if (pDpfProfile->FiltLevelRegConf.p_fac_bl1) {
        free(pDpfProfile->FiltLevelRegConf.p_fac_bl1);
      }
	  if (pDpfProfile->FiltLevelRegConf.p_fac_mid) {
        free(pDpfProfile->FiltLevelRegConf.p_fac_mid);
      }
	  if (pDpfProfile->FiltLevelRegConf.p_fac_sh0) {
        free(pDpfProfile->FiltLevelRegConf.p_fac_sh0);
      }
	  if (pDpfProfile->FiltLevelRegConf.p_fac_sh1) {
        free(pDpfProfile->FiltLevelRegConf.p_fac_sh1);
      }
	  if (pDpfProfile->FiltLevelRegConf.p_FiltLevel) {
        free(pDpfProfile->FiltLevelRegConf.p_FiltLevel);
      }
	  if (pDpfProfile->FiltLevelRegConf.p_grn_stage1) {
        free(pDpfProfile->FiltLevelRegConf.p_grn_stage1);
      }
	  if (pDpfProfile->FiltLevelRegConf.p_thresh_bl0) {
        free(pDpfProfile->FiltLevelRegConf.p_thresh_bl0);
      }
	  if (pDpfProfile->FiltLevelRegConf.p_thresh_bl1) {
        free(pDpfProfile->FiltLevelRegConf.p_thresh_bl1);
      }
	  if (pDpfProfile->FiltLevelRegConf.p_thresh_sh0) {
        free(pDpfProfile->FiltLevelRegConf.p_thresh_sh0);
      }
	  if (pDpfProfile->FiltLevelRegConf.p_thresh_sh1) {
        free(pDpfProfile->FiltLevelRegConf.p_thresh_sh1);
      }
...
(
  ...
  if (NULL == pNewGoc) {
   ...
   if(pNewGoc != NULL){
     ...
     TRACE(CAM_CALIBDB_API_ERROR, "%s malloc fail\n", __FUNCTION__);
	 return (RET_INVALID_PARM);
   }
  } else {
   return (RET_INVALID_PARM);
