...
static struct pll_clk_set apll_clks[] = {
	 ...
	 */
	_APLL_SET_CLKS(1200000, 1, 50, 1, 1, 1, 0,    1, 4, 8, 4, 2, 2),
	_APLL_SET_CLKS(1100000, 12, 550, 1, 1, 1, 0,    1, 4, 8, 4, 2, 2),
	_APLL_SET_CLKS(1080000, 1, 84, 2, 1, 1, 0,   1, 4, 8, 4, 2, 2),
	_APLL_SET_CLKS(960000, 1, 80, 2, 1, 1, 0,   1, 4, 4, 8, 2, 2),
	_APLL_SET_CLKS(900000, 4, 300, 2, 1, 1, 0,   1, 4, 4, 4, 2, 2),
